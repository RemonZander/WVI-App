...
db.prepare(`INSERT INTO "WVIs" ("PMP_enkelvoudige_objectnaam", "PPLG", "Objecttype", "Geocode", "Contractgebiednummer", "Equipmentnummer", "RD X-coordinaat", "RD Y-coordinaat", "Template", "Producent", "Endpoint") 
VALUES (?,?,?,?,?,?,?,?,?,?,?)`).run(["GK.KTR.01", "KTR", "Electrisch 230V", "42", "28", "10177685", "168057,575", "438094,826", "Elektrisch", "Heatpoint", "opc.tcp://localhost:10001/OPCUA-Player"]);
db.prepare(`INSERT INTO "WVIs" ("PMP_enkelvoudige_objectnaam", "PPLG", "Objecttype", "Geocode", "Contractgebiednummer", "Equipmentnummer", "RD X-coordinaat", "RD Y-coordinaat", "Template", "Producent", "Endpoint") 
VALUES (?,?,?,?,?,?,?,?,?,?,?)`).run(["GK.WW.01", "WW", "Electrisch 230V", "607", "30", "11309660", "246427,143", "442796,435", "Elektrisch", "Pintsch Aben", "opc.tcp://localhost:10002/OPCUA-Player"]);
db.prepare(`INSERT INTO "WVIs" ("PMP_enkelvoudige_objectnaam", "PPLG", "Objecttype", "Geocode", "Contractgebiednummer", "Equipmentnummer", "RD X-coordinaat", "RD Y-coordinaat", "Template", "Producent", "Endpoint") 
...
db.prepare(`INSERT INTO "WVIs" ("PMP_enkelvoudige_objectnaam", "PPLG", "Objecttype", "Geocode", "Contractgebiednummer", "Equipmentnummer", "RD X-coordinaat", "RD Y-coordinaat", "Template", "Producent", "Endpoint") 
VALUES (?,?,?,?,?,?,?,?,?,?,?)`).run(["GK.GO.01", "GO", "Gasbrander LD", "31", "32", "11490221", "236596,456", "472054,759", "Gasbrander", "Pintsch Aben", "opc.tcp://localhost:10004/OPCUA-Player"]);
db.prepare(`INSERT INTO "WVIs" ("PMP_enkelvoudige_objectnaam", "PPLG", "Objecttype", "Geocode", "Contractgebiednummer", "Equipmentnummer", "RD X-coordinaat", "RD Y-coordinaat", "Template", "Producent", "Endpoint") 
VALUES (?,?,?,?,?,?,?,?,?,?,?)`).run(["GK.RV.01", "RV", "Electrisch 230V", "60", "27", "11117013", "203172,945", "366014,489", "Elektrisch", "Pro-Emium BV", "opc.tcp://localhost:10005/OPCUA-Player"]);
db.prepare(`INSERT INTO "WVIs" ("PMP_enkelvoudige_objectnaam", "PPLG", "Objecttype", "Geocode", "Contractgebiednummer", "Equipmentnummer", "RD X-coordinaat", "RD Y-coordinaat", "Template", "Producent", "Endpoint") 
VALUES (?,?,?,?,?,?,?,?,?,?,?)`).run(["GK.RV.02", "RV", "Electrisch 230V", "60", "27", "10124573", "203366,237", "366317,603", "Elektrisch", "Pro-Emium BV", "opc.tcp://localhost:10006/OPCUA-Player"]);
db.prepare(`INSERT INTO "WVIs" ("PMP_enkelvoudige_objectnaam", "PPLG", "Objecttype", "Geocode", "Contractgebiednummer", "Equipmentnummer", "RD X-coordinaat", "RD Y-coordinaat", "Template", "Producent", "Endpoint") 
